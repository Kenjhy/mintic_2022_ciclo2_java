...
//dogObjectList.add(dog);
    ...
    private void btnExportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarActionPerformed
        ...
        book.setSheetName(0, "Dogs");  //nombre de la hoja dentro de excel

        //crear la fila de encabezados como un array de cadenas
        ...
        //se crea la primera fila con los respectivos encabezados creados        
        ...
        //se recorre la lista que contiene las mascotas, 
        //en cada fila van los valores de los campos del encabezado 
        ...
        try {
            //se da salida a un archivo excel externo, para abrir
            FileOutputStream file = new FileOutputStream("dog_list_resport.xls");
            book.write(file);
            file.close();
