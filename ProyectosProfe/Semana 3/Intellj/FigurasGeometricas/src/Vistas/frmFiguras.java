...
public class frmFiguras extends javax.swing.JFrame {
    ...
    public frmFiguras() {
        initComponents();
        String[] titulos = new String[] {"Ancho", "Alto", "Area", "Per�metro"};        
    ...
    private void initComponents() {
        ...
        jLabel8.setText("RADIO BUTTON - OPCIONES SELECCI�N �NICA");
        ...
        tblRectangulos.setModel(new DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        cmdRadios.setText("Qu� Opci�n de Radios??");
        ...
        cmdCheckBox.setText("Qu� Opciones de Checks?");
        ...
        jLabel6.setText("CHECK BOX - CASILLAS DE VERIFICACI�N - MULTIPLES OPCIONES");

        jLabel7.setText("RADIO BUTTON - OPCIONES SELECCI�N �NICA");

        cboTriangulos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Seleccionar Relleno--", "Amarillo", "Azul", "Rojo" }));

        cmdCombos.setText("Qu� Opci�n del Combo??");
        ...
        jLabel9.setText("COMBOSBOX - CUADROS COMBINADOS - OPCIONES SELECCI�N �NICA");
        ...
        cmdRadioss.setText("Cu�l selecciono?");
