...
public class Rectangulo extends Figura {
    ...
    public Rectangulo(double alto, double ancho, String nombre, double area, 
        ...
        System.out.print("\nNombre Rect�ngulo: "); this.nombre = teclado.nextLine();
    ...
    /*
     * Sobrescribimos los m�todos heredados de la clase madre Figura
     * Los atributos �rea y per�metro son visibles en el �mbito de Rectangulo
